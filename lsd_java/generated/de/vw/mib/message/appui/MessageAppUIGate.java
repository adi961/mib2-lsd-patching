...
extends AbstractHmiAppUIGate {
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{569, 615};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{86, 164, 165, 166, 309, 310, 311, 312, 313, 314, 315, 316, 317, 318, 319, 320, 373, 480};
    }
}
