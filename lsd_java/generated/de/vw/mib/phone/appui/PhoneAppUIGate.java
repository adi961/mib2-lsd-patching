...
extends AbstractHmiAppUIGate {
    ...
    static {
        ...
        ENTRY_POINTS_OF_LAYER_MAIN = new int[]{583, 617};
        DYNAMIC_STATEMACHINES_OF_LAYER_POPUP = new int[]{0, 1, 2, 3, 4, 5, 71, 72, 73, 77, 78, 79, 80, 81, 82, 83, 89, 90, 91, 92, 93, 94, 95, 96, 97, 98, 99, 100, 101, 102, 118, 119, 120, 121, 122, 123, 124, 125, 182, 183, 184, 185, 186, 187, 188, 189, 190, 191, 192, 193, 194, 195, 242, 243, 244, 245, 246, 247, 248, 338, 339, 340, 341, 342, 343, 344, 345, 346, 347, 348, 477, 482, 483, 485};
    }
}
