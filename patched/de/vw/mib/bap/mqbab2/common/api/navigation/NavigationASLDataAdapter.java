...
INavServiceStateListener {
   ...
   // @Override
    protected int[] getListIds() {
        System.out.println("AADEBUG: getListIds");
        return new int[]{};
    }
   ...
   // @Override
    public void addNavigationServiceListener(NavigationServiceListener navigationServiceListener, int[] nArray) {
        StringBuffer sb = new StringBuffer(); // Using StringBuffer for efficiency
        sb.append("[");
        ...
        System.out.println("AADEBUG: addNavigationServiceListener: "+  navigationServiceListener.getClass().getName() + "IDS: " + sb.toString());
